...
/* uncomment next line to replace march-C by March-X RAM test */
/* #define USE_MARCH_X */
...
#define SYSTICK_2_ms_HSI ((uint32_t)48000uL) /* HSI = 24MHz */
#define SYSTICK_2_ms_HSE ((uint32_t)48000uL) /* HSE = 24MHz */
...
#define HSI_Freq    ((uint32_t)24000000uL)
