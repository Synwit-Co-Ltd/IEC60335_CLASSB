...
#define EXTERN extern
  ...
  /* Counter for verifying correct program execution at start 用于在开始时验证正确程序执行的计数器*/
  ...
  EXTERN uint32_t StartUpClockFreq        __attribute__((section(".bss.CLASS_B_RAM")));
  EXTERN uint32_t StartUpClockFreqInv     __attribute__((section(".bss.CLASS_B_RAM_REV")));

  /* First period measure stored as reference for run-time checks */
  EXTERN uint32_t RefHSEPeriod            __attribute__((section(".bss.CLASS_B_RAM")));
  EXTERN uint32_t RefHSEPeriodInv         __attribute__((section(".bss.CLASS_B_RAM_REV")));

  /* Last period measure sample stored for run-time checks */
  EXTERN uint32_t LastHSEPeriod           __attribute__((section(".bss.CLASS_B_RAM")));
  EXTERN uint32_t LastHSEPeriodInv        __attribute__((section(".bss.CLASS_B_RAM_REV")));

  /* Last period measure stored as reference for run-time checks */
  EXTERN uint32_t CurrentHSEPeriod        __attribute__((section(".bss.CLASS_B_RAM")));
  EXTERN uint32_t CurrentHSEPeriodInv     __attribute__((section(".bss.CLASS_B_RAM_REV")));
  ...
  /* Pointer to FLASH for crc32 run-time tests */
  EXTERN uint8_t *p_RunCrc32Chk           __attribute__((section(".bss.CLASS_B_RAM")));
  EXTERN uint8_t *p_RunCrc32ChkInv        __attribute__((section(".bss.CLASS_B_RAM_REV")));
...
/* Reference 32-bit CRC for run-time tests */
  ...
  /* Current FLASH 16-bit Crc */
  EXTERN uint16_t CurrentCrc16            __attribute__((section(".bss.CLASS_B_RAM")));
  EXTERN uint16_t CurrentCrc16Inv         __attribute__((section(".bss.CLASS_B_RAM_REV")));
  
  /* Current FLASH 32-bit Crc */
  EXTERN uint32_t CurrentCrc32            __attribute__((section(".bss.CLASS_B_RAM")));
  EXTERN uint32_t CurrentCrc32Inv         __attribute__((section(".bss.CLASS_B_RAM_REV")));

  /* Magic pattern for Stack overflow in this array */
  EXTERN __IO uint32_t StackOverFlowPtrn[4]   __attribute__((section(".bss.STACK_BOTTOM")));
