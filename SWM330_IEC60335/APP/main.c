...
void Peripheral_Enable(void)
{
  ...
  PWM_initStruct.Mode = PWM_CENTER_ALIGNED;
	...
	PWM_initStruct.Period = 1800;				  // 18M/1800 = 100kHz, 50kHz for center alignment mode
	PWM_initStruct.HdutyA =  900;				  // 900/1800 = 50%
	PWM_initStruct.DeadzoneA = 0;		   		
	PWM_initStruct.IdleLevelA = 0;
	PWM_initStruct.IdleLevelAN= 0;
	PWM_initStruct.OutputInvA = 0;
	PWM_initStruct.OutputInvAN= 0;
	PWM_initStruct.HdutyB =  900;				
	...
	/* Mask */
	PWM_CmpTrigger(PWM0, 400, PWM_DIR_UP, 4, PWM_TRG_1, 7);	// when counting up and counter == 1500, PWM will generate PWM_TRG_1 signal
