...
; Alignement here must correspond to the size of tested block at FLASH run time test (16 words ~ 64 bytes)!!! 这里的对齐必须对应于FLASH运行时测试的测试块的大小(16个字~ 64字节)!!
                ALIGN

__Check_Sum     DCD     0x528796EA               ; Check sum computed externaly
